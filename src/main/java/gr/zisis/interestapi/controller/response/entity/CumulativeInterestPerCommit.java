 ...
 *
 */
public class CumulativeInterestPerCommit {
	
	private String sha;
	private int revisionCount;
	private BigDecimal interestEu;
	
	public CumulativeInterestPerCommit() { }
	
	public CumulativeInterestPerCommit(String sha, int revisionCount, BigDecimal interestEu) {
		this.sha = sha;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CumulativeInterestPerCommit other = (CumulativeInterestPerCommit) obj;
		if (interestEu == null) {
